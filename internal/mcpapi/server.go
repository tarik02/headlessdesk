...
func NewServer(service *control.Service, authorizer *authz.Authorizer) *mcp.Server {
	...
	}, requireToolScope(authorizer, "read:status", func(ctx context.Context, req *mcp.CallToolRequest, _ struct{}) (*mcp.CallToolResult, control.Status, error) {
	...
	}, requireToolScope(authorizer, "read:screenshot", func(ctx context.Context, req *mcp.CallToolRequest, args screenshotArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "write:mouse", func(ctx context.Context, req *mcp.CallToolRequest, args clickArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "write:mouse", func(ctx context.Context, req *mcp.CallToolRequest, args dragArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "write:mouse", func(ctx context.Context, req *mcp.CallToolRequest, args moveArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "write:mouse", func(ctx context.Context, req *mcp.CallToolRequest, args scrollArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "write:keyboard", func(ctx context.Context, req *mcp.CallToolRequest, args keypressArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "write:keyboard", func(ctx context.Context, req *mcp.CallToolRequest, args typeArgs) (*mcp.CallToolResult, any, error) {
	...
	}, requireToolScope(authorizer, "read:wait", func(ctx context.Context, req *mcp.CallToolRequest, args waitArgs) (*mcp.CallToolResult, any, error) {
...
func requireToolScope[In, Out any](authorizer *authz.Authorizer, scope string, next mcp.ToolHandlerFor[In, Out]) mcp.ToolHandlerFor[In, Out] {
...
func authorizeTool(authorizer *authz.Authorizer, req *mcp.CallToolRequest, scope string) error {
	...
	if err := authorizer.AuthorizeScopes(authz.AudienceMCP, scope, req.Extra.TokenInfo.Scopes); err != nil {
		return err
	}
	return nil
}
